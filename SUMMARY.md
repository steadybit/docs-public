...
* [Install Outpost Agent](docs-public/install-and-configure/install-outpost-agent/README.md)
  ...
  * [Extension Discovery](docs-public/install-and-configure/install-outpost-agent/extension-discovery.md)
  * [Using Mutual TLS for Extensions](docs-public/install-and-configure/install-outpost-agent/using-mutual-tls-for-extensions.md)
  * [Configuration Options](docs-public/install-and-configure/install-outpost-agent/advanced-configuration.md)
  * [Migrating From the Legacy Agent](docs-public/install-and-configure/install-outpost-agent/migrating-from-the-legacy-agent.md)
  * [Migration Breaking Changes](docs-public/install-and-configure/install-outpost-agent/migration-breaking-changes.md)
* [Install Legacy Agents](docs-public/install-and-configure/install-agents-legacy/README.md)
  * [Architecture](docs-public/install-and-configure/install-agents-legacy/architecture.md)
  * [Install as Docker Container](docs-public/install-and-configure/install-agents-legacy/docker.md)
  * [Install on Kubernetes](docs-public/install-and-configure/install-agents-legacy/kubernetes/README.md)
  * [Install on Linux Hosts](docs-public/install-and-configure/install-agents-legacy/host.md)
  * [Install on Amazon Elastic Container Service (ECS) running on EC2](docs-public/install-and-configure/install-agents-legacy/aws-ecs-ec2.md)
  * [Install AWS Cloud Service Agent](docs-public/install-and-configure/install-agents-legacy/aws-cloud/README.md)
  * [Configuration Options](docs-public/install-and-configure/install-agents-legacy/advanced-configuration.md)
  * [FAQ](docs-public/install-and-configure/install-agents-legacy/faq.md)

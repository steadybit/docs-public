...
* [Install Agents](docs-public/install-and-configure/install-agents/README.md)
  ...
  * [Install using Docker Compose](docs-public/install-and-configure/install-agents/install-as-docker-container.md)
  * [Install on Amazon ECS](docs-public/install-and-configure/install-agents/aws-ecs-ec2.md)
  * [Extension Discovery](docs-public/install-and-configure/install-agents/extension-discovery.md)
  * [Using Mutual TLS for Extensions](docs-public/install-and-configure/install-agents/using-mutual-tls-for-extensions.md)
  * [Configuration Options](docs-public/install-and-configure/install-agents/advanced-configuration.md)
  * [Migrating From the Legacy Agent](docs-public/install-and-configure/install-agents/migrating-from-the-legacy-agent.md)
  * [Migration Breaking Changes](docs-public/install-and-configure/install-agents/migration-breaking-changes.md)
* [Install Legacy Agents](install-and-configure/install-agents-legacy/README.md)
  ...
  * [Install on Kubernetes](install-and-configure/install-agents-legacy/kubernetes/README.md)
  * [Install on Linux Hosts](install-and-configure/install-agents-legacy/host.md)
  * [Install on Amazon Elastic Container Service (ECS) running on EC2](install-and-configure/install-agents-legacy/aws-ecs-ec2.md)
  * [Install AWS Cloud Service Agent](install-and-configure/install-agents-legacy/aws-cloud/README.md)
  * [Configuration Options](install-and-configure/install-agents-legacy/advanced-configuration.md)
  * [FAQ](install-and-configure/install-agents-legacy/faq.md)

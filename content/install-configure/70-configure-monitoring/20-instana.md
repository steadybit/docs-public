...
Once Instana has been configured in the platform's settings, you can use the `Instana State Check` in an experiment. Detailed explanation can be found in [Learn / Monitoring / Instana](../../learn/40-integrate-monitoring/30-instana).

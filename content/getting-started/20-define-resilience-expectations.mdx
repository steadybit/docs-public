...
- a running [steadybit](https://www.steadybit.com/get-started/) platform
...
## Next Steps
 ...
 - [Learn about policies and tasks referenced through service definition files.](https://github.com/steadybit/definitions)

...
Below you will see an example of a YAML file to run the chaosmesh agent. Please replace '<replace-with-api-key>' with your specific API-Key and run the shown commands to encode the key correctly.

...
2. Make sure the extension is reachable and known by the Steadybit agent. Please check [Install Outpost Agent (Preview) -> Extension Discovery](docs-public/install-and-configure/install-agents/extension-discovery.md) for details.

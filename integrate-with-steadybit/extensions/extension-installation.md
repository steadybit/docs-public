...
2. Make sure the extension is reachable and known by the Steadybit agent. Please check [Install Outpost Agent (Preview) -> Extension Discovery](../../install-and-configure/install-outpost-agent-preview/extension-discovery.md) for details.

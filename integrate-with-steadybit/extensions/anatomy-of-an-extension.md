...
At a high level, extensions are:

* separately deployed processes,
* typically packaged as Docker images,
* running within your infrastructure, and
* exposing an HTTP interface that complies with one or more extension APIs.
...
Extensions are typically packaged as Docker images and consequently run as containers. Because extensions may require additional configuration and permissions, users carry the responsibility for the rollout of extensions. We offer ready-made Helm charts to facilitate the rollout of our official extensions.

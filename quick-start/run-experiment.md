...
![Create experiment step 2](<../use-steadybit/experiments/create-experiment-step1 (2).png>)
...
![Create experiment step 3](<../use-steadybit/experiments/create-experiment-step2 (2).png>)
...
![Create experiment step 4](<../use-steadybit/experiments/create-experiment-step3 (2).png>)
...
![Create experiment step 5](<../use-steadybit/experiments/create-experiment-step4 (3).png>)
...
![Run experiment - execution window](<run-experiment-run2 (8).png>)

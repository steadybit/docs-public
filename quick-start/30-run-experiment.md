...
![Create experiment step 1](../getting-started/img-run/experiment-step1.png)
...
![Create experiment step 2](../getting-started/img-run/experiment-step2.png)
...
![Create experiment step 3](../getting-started/img-run/experiment-step3.png)
...
![Create experiment step 4](../getting-started/img-run/experiment-step4.png)
...
![Create experiment step 5](../getting-started/img-run/experiment-step5.png)
...
![Create experiment step 6](../getting-started/img-run/experiment-step6.png)
...
![Run experiment - system under test](../getting-started/img-run/experiment-run1.png)

When hitting the "run experiment"-button you see the steadybit execution window.

![Run experiment - execution window](../getting-started/img-run/experiment-run2.png)

...
{% hint style="info" %}
Without agents, there is no connection to your environment.
And without extensions, there is no discovery data and thus no experiments are possible.
{% endhint %}
...
Simply copy the script matching your technology and run it in the environment you want to experiment in.

![Steadybit Onboarding - Setup Scripts](set-up-agents-step1.png)

> If you need a demo application to play around with, you can [deploy our Shopping Demo into a Minikube or AWS EKS cluster](../deploy-example-application/).
...
That's it!
You are welcomed by our Dashboard, and you are ready to take off by [designing and running your first Chaos Engineering experiment](../run-experiment/).

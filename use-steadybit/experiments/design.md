...
The documentation of a template is coming from the [experiment template's description](../../install-and-configure/manage-experiment-templates/#template-description). The documentation of an action is provided via the [Hub Connection](../../integrate-with-steadybit/hubs/), and can also be provided for your own custom actions.

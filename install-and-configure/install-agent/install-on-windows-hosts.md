...
Double-click the downloaded _.msi_ installer and follow the installation instructions. During the installation process you must specify the _Agent Key_ and _Registration URL_, and are also able to configure proxy settings in a dedicated dialog.

![Windows Agent Installer](../../.gitbook/assets/windows-agent-installer.png)
